...
ALTER TABLE productos ADD FOREIGN KEY (created_by) REFERENCES users(id);
ALTER TABLE productos ADD FOREIGN KEY (update_by) REFERENCES users(id);
ALTER TABLE inventarios ADD FOREIGN KEY (id_bodega) REFERENCES bodegas(id);
ALTER TABLE inventarios ADD FOREIGN KEY (id_producto) REFERENCES productos(id);
ALTER TABLE inventarios ADD FOREIGN KEY (created_by) REFERENCES users(id);
ALTER TABLE inventarios ADD FOREIGN KEY (update_by) REFERENCES users(id);
...
INSERT INTO `users` (`id`, `nombre`, `email`, `email_verified_at`, `estado`, `created_by`, `updated_by`, `foto`, `password`, `created_at`, `updated_at`, `deleted_at`) VALUES
